...
def cli(record, certutil, url, path):
    ...
    mitmdump_log = open("mitmdump.log", "w+")
    ...
    mitmdump_process = subprocess.Popen(command, stdout=mitmdump_log)
    ...
    if record:
        raw_input("Press any key to start mitmdump recording...")
    ...
    raw_input("Press any key to stop mitmdump...")
    mitmdump_process.terminate()
    mitmdump_process.wait()
